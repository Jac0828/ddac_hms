...
const RoomDetails: React.FC = () => {
  ...
  const getMemberDiscount = (tier?: string) => {
    switch (tier?.toLowerCase()) {
      case 'platinum': return 0.75;
  ...
  const memberPrice = room ? Math.round(room.pricePerNight * getMemberDiscount(user?.membershipTier)) : 0;
